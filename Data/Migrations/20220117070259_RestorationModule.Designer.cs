...
namespace PensionSystem.Data.Migrations
{
    ...
    [Migration("20220117070259_RestorationModule")]
    partial class RestorationModule
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PensionSystem.Entities.Models.ArrearsPayment", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ArrearsPayment");
                });
            ...
            modelBuilder.Entity("PensionSystem.Entities.Models.HBLArrears", b =>
                {
                    ...
                    b.HasIndex("PensionerId", "FromMonth")
                        .IsUnique();

                    b.HasIndex("PensionerId", "ToMonth")
                        .IsUnique();

                    b.ToTable("HBLArrears");

                    b.HasDiscriminator<string>("Discriminator").HasValue("HBLArrears");
                });
            ...
            modelBuilder.Entity("PensionSystem.Entities.Models.HBLRestoration", b =>
                {
                    b.HasBaseType("PensionSystem.Entities.Models.HBLArrears");

                    b.HasDiscriminator().HasValue("HBLRestoration");
                });

            modelBuilder.Entity("PensionSystem.Entities.Models.RestorationPayment", b =>
                {
                    b.HasBaseType("PensionSystem.Entities.Models.ArrearsPayment");

                    b.HasDiscriminator().HasValue("RestorationPayment");
                });
